...
class Admin(ctk.CTk):
    def __init__(self):
        ...
        self.img1 = Image.open("pictures\login_icon_176905.png")
        ...
        self.txt_password = ctk.CTkEntry(self.frame3, width=300, height=40, font=("Arial", 17, "bold"),
                                         justify="center", border_width=3, border_color="#27242b", show="*")
        self.txt_password.place(x=15, y=100)

        self.check_box = ctk.CTkCheckBox(self.frame3, text="show Password", command=self.Hide_pass,
